...
console.log(exclaimThree("yayayay"))
...
const colorRating = faveColorFinder("blk")
...
const thatsOdd = (num) => num % 2 === 1 ? "This is odd indeed": "That's not odd!"
...
console.log(allUpper(sampleString))
...
console.log(emailCheck("Parkersheehan007@gmail.com"))
...
let arrayIsAssencing = isAscending(sampleArray)
console.log(arrayIsAssencing)
